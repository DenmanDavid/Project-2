...
var wobbleSpeedCoin = 8, wobbleDistCoin = 0.07;
...
var wobbleSpeedMob = 2.5;
var wobbleDistMob = .8;

Mob.prototype.act = function(step) {
	this.wobble += step * wobbleSpeedMob;
	var wobblePos = Math.sin(this.wobble) * wobbleDistMob;
